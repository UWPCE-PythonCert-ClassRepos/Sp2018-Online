...
def login_mongodb_cloud():
    ...
    connectionString = f'mongodb://{user}:{pw}' \
                        '@cluster0-shard-00-00-9ecir.mongodb.net:27017,'  \
                        'cluster0-shard-00-01-9ecir.mongodb.net:27017,'  \
                        'cluster0-shard-00-02-9ecir.mongodb.net:27017/test?'  \
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-ehcmmcdgmknagbkecjhgegbl.dbs.graphenedb.com:24786'
