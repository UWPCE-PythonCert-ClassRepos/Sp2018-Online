...
config_file = '/Users/davidrusso/Documents/Classes/Python Certificate/Advanced Python/Sp2018-Online/students/david_russo/lesson08/.config/config.ini'
...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb://{user}:{pw}'
                                 '@cluster0-shard-00-00-0j0y4.mongodb.net:27017,cluster0-shard-00-01-0j0y4.mongodb.net:27017,cluster0-shard-00-02-0j0y4.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true')
