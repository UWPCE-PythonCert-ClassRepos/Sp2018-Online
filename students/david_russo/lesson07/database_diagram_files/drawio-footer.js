...
Draw.loadPlugin(function(ui) {
	...
	var rate = '<a id="geFooterLink1" title="Please Rate Us" target="_blank" href="https://chrome.google.com/webstore/detail/drawio-diagrams/onlkggianjhjenigcpigpjehhpplldkc/reviews"' +
		   ...
		   '<img border="0" align="absmiddle" style="margin-top:-6px;cursor:pointer;" src="' + star + '">' +
                   ...
                   '<img border="0" align="absmiddle" style="margin-top:-6px;cursor:pointer;" src="' + star + '">' +
		   '<img border="0" align="absmiddle" style="margin-top:-6px;cursor:pointer;" src="' + star + '" ' +
		   'onclick="javascript:window.open(\'https://marketplace.atlassian.com/apps/1211413/draw-io-diagrams-for-jira?hosting%3Dserver%26tab%3Dreviews\');">';
		...
		window.setTimeout(function()
		{
			rotate(td2, rate, 1000, function()
			{
				mxEvent.addListener(td2, 'click', mxUtils.bind(this, function()
       	 	        	{
					td2.innerHTML = '<a href="javascript:void(0)">Thanks for your review!</a>';
                		}));
			});
		}, 5000);
	...
	//	        'src="images/drawlogo48.png"/>Use draw.io offline - draw.io Desktop</a>')
		...
		/*var userChanged = function()
		{
			...
			if (user != null && user.email != null && user.email.substring(user.email.length - 10) == '@gmail.com')
			{
				...
				window.setTimeout(function()
				{
					rotate(td, '<a title="Please help us to 5 stars" href="https://chrome.google.com/webstore/detail/drawio-pro/onlkggianjhjenigcpigpjehhpplldkc/reviews" target="_blank">' +
		...
		window.setTimeout(function()
		{
			rotate(td, (Math.random() < 0.5) ? like : tweet);
		}, 30000);
