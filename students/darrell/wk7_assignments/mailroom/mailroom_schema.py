...
class Donor(BaseModel):
    ...
    donor_first_name = CharField(primary_key= True, max_length= 30)
    donor_last_name = CharField( max_length = 30)
    donor_city= CharField( max_length = 30)
...
class Donation(BaseModel):
    ...
    donation_amount = DecimalField(auto_round= False, max_digits=10, decimal_places=2)
