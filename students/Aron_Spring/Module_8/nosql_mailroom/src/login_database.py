...
log = utilities.configure_logger('default', '../logs/login_databases_mailroom.log')
...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb://{user}:{pw}'
                                '@cluster0-shard-00-00-wq3tu.mongodb.net:27017,'
                                'cluster0-shard-00-01-wq3tu.mongodb.net:27017,'
                                'cluster0-shard-00-02-wq3tu.mongodb.net:27017/test'
                                '?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin')
    #client = pymongo.MongoClient(f'mongodb://arondba:ARZp1ePFedd0dTAk@cluster0-shard-00-00-wq3tu.mongodb.net:27017,cluster0-shard-00-01-wq3tu.mongodb.net:27017,cluster0-shard-00-02-wq3tu.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true')
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-oiopfkohpmongbkelncgegbl.dbs.graphenedb.com:24786'
