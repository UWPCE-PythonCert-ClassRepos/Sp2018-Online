...
config_file = Path(__file__).parent.parent / '.mysetting.py/mysetting.py.ini'
...
def login_mongodb_cloud():
    ...
    try:
        ...
        print(f'error: {e}')
    url = (f"mongodb://{user}:{pw}@cluster0-shard-00-00-wphqo.mongodb.net:27017,"
...
#     """
#     try:
#         mysetting.py.read(config_file)
#         host = mysetting.py["redis_cloud"]["host"]
#         port = mysetting.py["redis_cloud"]["port"]
#         pw = mysetting.py["redis_cloud"]["pw"]
#
#
#     except Exception as e:
#         print(f'error: {e}')
...
#     mysetting.py.read(config_file)
#
#     graphenedb_user = mysetting.py["neo4j_cloud"]["user"]
#     graphenedb_pass = mysetting.py["neo4j_cloud"]["pw"]
