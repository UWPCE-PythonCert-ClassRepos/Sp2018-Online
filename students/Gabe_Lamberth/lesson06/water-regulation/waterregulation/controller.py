...
class Controller(object):
    ...
    def tick(self):
        ...
        que_sensor = self.sensor.measure()
        que_pump = self.pump.get_state()
        que_decider = self.decider.decide(que_sensor, que_pump, self.actions)

        state = self.pump.set_state(que_decider)
