...
def run_example():
    ...
    try:
        ...
        log.info('--------------------------------------')
        r.rpush('id1', 'Bill Khoobs', '832-333-1111', '77029', 'bill@example.net')
        r.rpush('id2', 'Jimbo Fisher', '832-333-2222', '77384')
        r.rpush('id3', 'Anthony Salo', '832-333-3333', '77090')
        r.rpush('id4', 'Julie McBath', '832-333-4444', '77028')
        r.rpush('id5', 'Elizabeth Stranger', '832-333-5555', '77029')
        r.rpush('id6', 'Savannah Smith', '832-333-6666', '77009')

        log.info('List the customers: ')
        print(f"Customer name: {r.lindex('id1', 0)}")
        print(f"Phone: {r.lindex('id1', 1)}")
        print(f"Zip Code: {r.lindex('id1', 2)}")
        print(f"Email: {r.lindex('id1', 3)}")
