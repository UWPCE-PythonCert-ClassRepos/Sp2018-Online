...
class Department(BaseModel):
    """
    This class defines a Persons department name (30 characters), department number (4 characters long and starts with a number), name of department manager, and the duration of days the job has been held.
    """
    ...
    # duration_in_days_job_held = DateTimeField()
    start_date = DateField(formats='YYYY-MM-DD')
    end_date = DateField(formats='YYYY-MM-DD')
    person_dept = ForeignKeyField(Person, null=False)
