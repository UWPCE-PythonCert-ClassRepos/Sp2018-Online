...
class Controller(object):
    ...
    def tick(self):
        ...
        query_sensor = self.sensor.measure()
        query_pump = self.pump.get_state()
        query_decider = self.decider.decide(query_sensor,
                                            query_pump, self.actions)

        new_state =  self.pump.set_state(query_decider)
