...
def run_example():
    ...
    try:
        ...
        r.rpush(1, 'One', '111-111-1111', '98000' )
        r.rpush(2, 'Two', '222-222-2222', '98001' )
        r.rpush(3, 'Three', '333-333-3333', '98002' )
        r.rpush(4, 'Four', '444-444-4444', '98003' )
        r.rpush(5, 'Five', '555-555-5555', '98004' )
        r.rpush(6, 'Six', '666-666-6666', '98005' )

        log.info('Retrieve Zip Code')
        zip_code = r.lindex('One', 1)
        print(zip_code)
        log.info('Retrieve Phone')
        phone = r.lindex('Three',0)
        print(phone)
